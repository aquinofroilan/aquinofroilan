                ...
                description={
                    <div className="w-full flex flex-col gap-3">
                        <p className="text-sm text-justify">
                            ...
                            and its powerful Next.js is the framework that powers this website. In terms of service and
                        ...
                        <p className="text-sm text-justify">
                            I recently received my information technology bachelor&apos;s degree (2025), and I&apos;m
                            still expand my knowledge outside of the classroom. I have a very self-directed approach to
                            learning—I actively use AI-based tools like ChatGPT and websites like YouTube and
                            FreeCodeCamp. and Claude to deepen my understanding and reaffirm ideas. My inquisitive
                            nature frequently results in Examine subjects using Dev.to, Medium, and technical
                            discussions on GitHub and Stack Overflow. archives.
                        </p>
                        <p className="text-sm text-justify">
                        ...
                        <p className="text-sm text-justify">
                            ...
                            and Kotlin will take a native approach to mobile development. At the same time, I&apos;m
