<script lang="ts">
    ...
    import { CredlyIcon, HackerRank, LeetCode, Github, Instagram, LinkedIn } from '$lib/components/atoms';
    
    let { class: className = '', RESUME_CV_LINK = '' } = $props<{ 
        class?: string;
        RESUME_CV_LINK?: string;
    }>();
</script>
            ...
            <div class="flex flex-col gap-5">
                <div>
                    ...
                    <div class="flex flex-col">
                        ...
                        >
                            <span class="text-xs">aquino.froilan.dev@outlook.com</span>
                        </a>
                    </div>
                </div>
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <Tooltip.Provider>
                            ...
                            <Tooltip.Root>
                                ...
                                <Tooltip.Content>
                                    <span class="text-xs">Credly</span>
                                </Tooltip.Content>
                            </Tooltip.Root>
                            <Tooltip.Root>
                                <Tooltip.Trigger class="w-full justify-center flex items-center py-2 px-2 rounded-md hover:bg-muted transition-colors">
                                ...
                                <Tooltip.Content>
                                    <span class="text-xs">HackerRank</span>
                                </Tooltip.Content>
                            </Tooltip.Root>
                            <Tooltip.Root>
                                <Tooltip.Trigger class="w-full justify-center flex items-center py-2 px-2 rounded-md hover:bg-muted transition-colors">
                                ...
                                <Tooltip.Content>
                                    <span class="text-xs">LeetCode</span>
                                </Tooltip.Content>
                            </Tooltip.Root>
                        </Tooltip.Provider>
                    </div>
