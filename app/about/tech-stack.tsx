...
import {
    ...
    TailWindCSS,
    Figma,
} from "@/app/about/landing-page-icons";
...
const TechStack = () => {
    ...
    const TechStack = [
        ...
        },
        {
            ...
            content: "PostgreSQL – an open-source relational database management system.",
        },
        {
            id: 5,
            url: "https://firebase.google.com/",
            component: <Firebase />,
            content: "Firebase – a platform developed by Google for creating mobile and web applications.",
        },
        {
            id: 6,
        ...
        },
        {
            ...
            component: <Figma />,
            content: "Figma – a cloud-based design tool for collaborative interface design.",
        },
    ];
    return (
        <>
