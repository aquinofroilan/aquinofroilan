...
export const NextJS = () => {
  return (
    <svg
      className="w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 fill-none"
      viewBox="0 0 15 15"
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
    ...
    >
      <g>
        <path
          ...
          className="fill-[#FFA000]"
        />
        <polygon
          className="fill-[#F57F17]"
